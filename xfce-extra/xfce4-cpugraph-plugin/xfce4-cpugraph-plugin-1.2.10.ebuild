...
DESCRIPTION="Graphical representation of CPU load"
HOMEPAGE="https://gitlab.xfce.org/panel-plugins/xfce4-cpugraph-plugin"
SRC_URI="https://gitlab.xfce.org/api/v4/projects/44/repository/archive.tar.bz2?sha=xfce4-cpugraph-plugin-1.2.10 -> xfce4-cpugraph-plugin-1.2.10.tar.bz2"
