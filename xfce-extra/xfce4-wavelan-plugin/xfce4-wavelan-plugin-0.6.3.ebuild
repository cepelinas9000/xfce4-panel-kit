...
DESCRIPTION=""
HOMEPAGE="https://gitlab.xfce.org/panel-plugins/xfce4-wavelan-plugin"
SRC_URI="https://gitlab.xfce.org/api/v4/projects/72/repository/archive.tar.bz2?sha=xfce4-wavelan-plugin-0.6.3 -> xfce4-wavelan-plugin-0.6.3.tar.bz2"
