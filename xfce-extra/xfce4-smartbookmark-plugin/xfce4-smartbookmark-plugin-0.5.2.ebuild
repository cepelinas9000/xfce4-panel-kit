...
HOMEPAGE="https://gitlab.xfce.org/panel-plugins/xfce4-smartbookmark-plugin"
SRC_URI="https://gitlab.xfce.org/api/v4/projects/64/repository/archive.tar.bz2?sha=0.5.2 -> xfce4-smartbookmark-plugin-0.5.2.tar.bz2"
