...
HOMEPAGE="https://gitlab.xfce.org/panel-plugins/xfce4-sensors-plugin"
SRC_URI="https://gitlab.xfce.org/api/v4/projects/63/repository/archive.tar.bz2?sha=xfce4-sensors-plugin-1.4.4 -> xfce4-sensors-plugin-1.4.4.tar.bz2"
