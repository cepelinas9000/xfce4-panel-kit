...
HOMEPAGE="https://gitlab.xfce.org/panel-plugins/xfce4-notes-plugin"
SRC_URI="https://gitlab.xfce.org/api/v4/projects/59/repository/archive.tar.bz2?sha=xfce4-notes-plugin-1.11.0 -> xfce4-notes-plugin-1.11.0.tar.bz2"
